...
function SerAvailable(Handle: TSerialHandle): Cardinal;
...
begin
  ...
  case BitsPerSec of
    ...
    else DCB.BaudRate := BitsPerSec; // Windows should provide non-standard bitrates on ports that support it, shouldn't it?
  end;
